<template>
  <div clas="flex flex-col">
    ...
    <div class="relative m-2">
      ...
      <input
        v-model="search"
        class="flex items-center w-full pl-12 text-sm font-normal text-black placeholder-gray-700 bg-porcelain border border-gray-200 rounded-full shadow dark:text-gray-100 dark:bg-dim-400 dark:border-dim-400 focus:bg-white dark:focus:bg-dim-900 focus:outline-none focus:border focus:border-blue-200 h-9"
    ...
    <SidebarRightCard title="What's happening">
      <SidebarRightCardItem v-for="whatsHappening in whatsHappeningItems">
        <div>
    ...
    <SidebarRightCard title="Who to follow">
      <SidebarRightCardItem v-for="whoToFollow in whoToFollowItems">
